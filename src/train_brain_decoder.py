...
def forward_pass(
    ...
    # TODO: Run cnn.apply
    # TODO: Use jnp.mean and optax.softmax_cross netropy to compute the cost.
    ce_loss = 0. # TODO: Find the actual cost value.
    return ce_loss


@jax.jit
def adjust_dimensions(eeg_input: jnp.ndarray) -> jnp.ndarray:
    """Adjusts the eeg_input dimensions to allow CNN processing.
...
def get_acc(
    ...
    accuracy = 0. # Return the actual accuracy instead of zero.
    return accuracy
...
if __name__ == "__main__":
    ...
    for e in range(epochs):
        ...
        for input_x, labels_y in bar:
            ...
            # TODO: commpute cel and the gradients using your wrapped forward pass.
            cel = 0. # TODO: Ensure cel contains the current cross entropy loss value.
        ...
        print("Validation accuracy {:2.3f} at epoch {}".format(val_accuracy, e))
        val_acc_list.append(val_accuracy)

    test_accuracy = get_acc(cnn, variables, test_set_x, test_set.y)
    print("Test accuracy: {:2.3f}".format(test_accuracy))
